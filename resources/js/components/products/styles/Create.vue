        ...
        <form id="form" :action="this.product_styles_create" method="POST">
          ...
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <label class="input-group-text" for="gender" id="label_gender">新增商品風格歸屬性別</label>
            </div>
          ...
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <label class="input-group-text" for="category" id="label_category">新商品風格歸屬部位</label>
            </div>
          ...
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <label class="input-group-text" for="new_style" id="label_style">新風格名稱</label>
            </div>
...
<script>
export default {
  props: ["product_styles_create", "styles", "errors", "olds", "men_categories", "women_categories"],
      ...
      switch (document.getElementById("gender").value) {
        case "men":
          ...
          this.jpMen_categories.forEach((element) => {
            mct += "<option value=" + element["category"] + ">" + element["category"] + "</option>";
          });
        ...
        case "women":
          ...
          this.jpWomen_categories.forEach((element) => {
            wct += "<option value=" + element["category"] + ">" + element["category"] + "</option>";
          });
