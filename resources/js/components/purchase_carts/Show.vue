      ...
      <div class="d-block" id="purchase_cart">
        ...
        <div class="card-body">
          ...
          <div v-for="(item, index) in purchase_lists" :key="item.id">
            <div class="container d-flex text-center" :id="'container_' + index">
              <div class="col-3">
              ...
              <div class="col-4 d-flex">
                <div class="m-auto">
                  <a :href="product_route + '/' + item['products_id']">{{ item["product_name"] }}</a>
                </div>
              </div>
              ...
              <div class="col-2 d-flex">
                <div class="input-group m-auto">
                  <div class="input-group-prepend">
                    <button class="btn bg-info p-1" v-on:click="change_quantity(index, 'decrease_btn')">
                      &#10134;
                    </button>
                  </div>
                  <input
                  ...
                  <div class="input-group-append">
                    <button class="btn bg-info p-1" v-on:click="change_quantity(index, 'increase_btn')">
                      &#10133;
                    </button>
                  </div>
                </div>
              ...
              <div class="col-1 d-flex">
                <div class="m-auto bg-danger btn" v-on:click="removePurchaseProduct(item, index)">&#10006;</div>
              </div>
            </div>
        ...
        <div class="card-footer">
          <div class="container">
            <div class="row text-right my-3">
              ...
              <div class="col-1" id="total_quantities">{{ total_quantities }}</div>
            </div>
            <div class="row text-right my-3">
            ...
            <div class="row text-right my-3">
              ...
              <div class="col-1 transport_fee" v-if="shipping_fee == 0">未選擇</div>
          ...
          <div class="d-flex">
            <div class="btn ml-auto w-25" v-on:click="nextStepBtn()">下一步</div>
          </div>
        </div>
      </div>
      ...
      <div class="d-none" id="payment_and_transport">
            ...
            <div class="row">
              <div class="col-6">
                <input
                  ...
                  v-on:click="chooseTransportMethod()"
                />
                <label for="othersConvenienceStores" class="pl-2">全家、OK、萊爾富 取貨付款</label>
              </div>
        ...
        <div class="card-footer">
          <div class="container">
            ...
            <div class="row text-right my-3">
              <div class="col-11">運費 :</div>
              <div class="col-1 transport_fee text-danger" v-if="shipping_fee == 0">未選擇</div>
              <div class="col-1 transport_fee" v-else>{{ shipping_fee }}</div>
            </div>
          ...
          <div class="d-flex">
            <div class="btn mr-auto w-25" v-on:click="previousStepBtn()">返回購物車</div>
            <div id="submit" class="btn ml-auto w-25 disabled" v-on:click="submit_the_order()">送出訂單</div>
          </div>
        </div>
      </div>
    </div>
...
<script>
export default {
  props: ["purchase_lists", "purchase_cart_route", "product_route"],
  ...
  methods: {
    removePurchaseProduct: function(e, index) {
      ...
      axios
        ...
        .then((res) => {
          ...
          document.getElementsByClassName("total_amount")[0].innerHTML = this.total_amount;
          document.getElementsByClassName("total_amount")[1].innerHTML = this.total_amount;

          document.getElementById("total_quantities").innerHTML = this.total_quantities;

          document.getElementsByClassName("order_amount")[0].innerHTML = this.order_amount;
          document.getElementsByClassName("order_amount")[1].innerHTML = this.order_amount;
        })
    ...
    change_quantity: function(e, button) {
      ...
      var ichange_purchase_quantity = document.getElementById("container_purchase_quantity_" + e).value;
      ...
      axios
        .patch(this.purchase_cart_route + "/" + this.purchase_lists[e]["purchase_carts_id"], {
        ...
        .then((res) => {
          ...
          this.purchase_lists[e]["purchase_quantity"] = res.data["update_data"]["purchase_quantity"];
          ...
          document.getElementById("container_amount_" + e).innerHTML =
            "$ " + res.data["update_data"]["purchase_quantity"] * res.data["update_data"]["price"];
    ...
    chooseTransportMethod() {
      setTimeout(() => {
        ...
        document.getElementsByClassName("transport_fee")[0].innerHTML = this.shipping_fee;
        document.getElementsByClassName("transport_fee")[1].innerHTML = this.shipping_fee;

        document.getElementsByClassName("order_amount")[0].innerHTML = this.order_amount;
        document.getElementsByClassName("order_amount")[1].innerHTML = this.order_amount;

        // remove the text-danger class
        document.getElementsByClassName("transport_fee")[1].classList.remove("text-danger");
    ...
    nextStepBtn() {
      ...
      document.getElementById("payment_and_transport").classList.remove("d-none");
    },

    previousStepBtn() {
      console.log("previousStepBtn");
      document.getElementById("payment_and_transport").classList.remove("d-block");
      ...
      axios
        ...
        .catch((err) => {
          if (err.response.data.message == "carts count less than 1") {
            document.getElementsByClassName("err_message")[0].innerHTML = "購物車內無商品，請先選購商品。";
          }
        });
    },
  },
