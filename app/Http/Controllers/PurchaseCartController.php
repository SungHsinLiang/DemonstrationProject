...
class PurchaseCartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $user_purchase_list = getPurchaseList(auth()->user()->id);
    ...
    {
        // $purchase_lists = PurchaseCart::where([
        //     ['user_id', auth()->user()->id],
        //     ['is_purchased', false],
        // ])->get();
    ...
    {
        // $purchase_lists = PurchaseCart::where('user_id', $user_id)->get();
        // return [
        //     'purchase_lists' => $purchase_lists,
        //     'test_data' => ['test', 'test123'],
        // ];

        // $purchase_lists = DB::table('products')
        //     ->where(['products.id' => 118])
        //     ->get();
    ...
    {
        $purchase_lists = DB::table('purchase_carts')
            ->select('products.id AS products_id', 'purchase_carts.id AS purchase_carts_id', 'products.product_name', 'purchase_carts.purchase_quantity', 'products.img_main_thumbnail', 'products.price')
            ->join('products', 'products.id', '=', 'purchase_carts.product_id')
            ->where([
                'user_id' => $user_id,
                'is_purchased' => 0,
